...
root = tk.Tk()
root.title("Vigenère Entschlüsselung")
root.geometry("500x300")

# Widgets
tk.Label(root, text="Geheimtext:").pack(pady=5)
...
btn_start = tk.Button(root, text="Entschlüsseln", command=verschluesseln, bg="lightblue")
